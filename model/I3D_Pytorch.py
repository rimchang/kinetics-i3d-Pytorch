...
class I3D(nn.Module):
    ...
    def __init__(self, num_classes=400, dropout_keep_prob = 1, input_channel = 3, spatial_squeeze=True):
        ...
        self.features = nn.Sequential(
            BasicConv3d(input_channel, 64, kernel_size=7, stride=2, padding=3), # (64, 28, 112, 112)
            nn.MaxPool3d(kernel_size=(1,3,3), stride=(1,2,2), padding=(0,1,1)),  # (64, 28, 56, 56)
            BasicConv3d(64, 64, kernel_size=1, stride=1), # (64, 28, 56, 56)
            BasicConv3d(64, 192, kernel_size=3, stride=1, padding=1),  # (192, 28, 56, 56)
            nn.MaxPool3d(kernel_size=(1,3,3), stride=(1,2,2), padding=(0,1,1)),  # (192, 28, 28, 28)
            Mixed_3b(), # (256, 28, 28, 28)
            Mixed_3c(), # (480, 28, 28, 28)
            nn.MaxPool3d(kernel_size=(3, 3, 3), stride=(2, 2, 2), padding=(1, 1, 1)), # (480, 14, 14, 14)
            Mixed_4b(),# (512, 14, 14, 14)
            Mixed_4c(),# (512, 14, 14, 14)
            Mixed_4d(),# (512, 14, 14, 14)
            Mixed_4e(),# (528, 14, 14, 14)
            Mixed_4f(),# (832, 14, 14, 14)
            nn.MaxPool3d(kernel_size=(2, 2, 2), stride=(2, 2, 2), padding=(0, 0, 0)), # (832, 7, 7, 7)
            Mixed_5b(), # (832, 7, 7, 7)
            Mixed_5c(), # (1024, 7, 7, 7)
